...
## About
Kocom Wallpad with RS485 for gks

## Installation

1. 홈어시스턴트의 Hass.io > ADD-ON STORE에서 Add new repository by URL에 [https://github.com/vifrost/kocom.py](https://github.com/koko317/kocom.py) 를 입력한 다음 ADD 버튼을 누릅니다.
